...
response remains an operational error for core's publication journal; writes are never retried.
...
submodules. One Git HTTP request is limited to 32 MiB, one response to 64 MiB, one changed file to
